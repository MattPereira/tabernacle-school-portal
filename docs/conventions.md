...
└── components/             presentational — the only place JSX-with-styling lives
    ...
    ├── admin/                the admin screen's forms (AdminForm, SubmitButton, RoleSelect)
